...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="/pimpinan/home" class="logo">
                <span class="logo-mini"><b>Head</b></span>
                <span class="logo-lg"><b>Head of Admin</b></span>
            </a>
                                ...
                                @foreach ($notif as $key => $value)
                                    <li>
                                        <a class="btn btn-clean font-weight-bold w-100 text-left"
                                            href="{{ route('pimpinan.pemeliharaan') }}">
